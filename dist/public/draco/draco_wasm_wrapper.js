...
var e = function(t) {
    ...
    function r(t, e) {
        if (0 === e || !t) return "";
        for (var r, n = 0, o = 0; n |= r = nt[t + o >> 0], (0 != r || e) && (o++, !e || o != e); ) ;
        if (e || (e = o), r = "", 128 > n) {
            for (;0 < e; ) n = String.fromCharCode.apply(String, nt.subarray(t, t + Math.min(e, 1024))), 
    ...
    function _() {
        x.HEAP8 = rt = new Int8Array(vt), x.HEAP16 = ot = new Int16Array(vt), x.HEAP32 = _t = new Int32Array(vt), 
        x.HEAPU8 = nt = new Uint8Array(vt), x.HEAPU16 = it = new Uint16Array(vt), x.HEAPU32 = at = new Uint32Array(vt), 
        x.HEAPF32 = pt = new Float32Array(vt), x.HEAPF64 = ut = new Float64Array(vt);
    }
    function a() {
        var t = x.usingWasm ? mt : dt, e = 2147483648 - t;
        if (_t[ft >> 2] > e) return !1;
        var r = It;
        for (It = Math.max(It, bt); It < _t[ft >> 2]; ) It = 536870912 >= It ? i(2 * It, t) : Math.min(i((3 * It + 2147483648) / 4, t), e);
        return (t = x.reallocBuffer(It)) && t.byteLength == It ? (x.buffer = vt = t, _(), 
        !0) : (It = r, !1);
    }
    function p(t) {
        for (;0 < t.length; ) {
    ...
    function c(t) {
        wt--, x.monitorRunDependencies && x.monitorRunDependencies(wt), 0 == wt && (null !== Gt && (clearInterval(Gt), 
        Gt = null), Ot && (t = Ot, Ot = null, t()));
    }
    function s() {
    ...
    function l() {
        var t = Ct.last;
        if (!t) return 0 | ($.setTempRet0(0), 0);
        var e = Ct.infos[t], r = e.type;
        if (!r) return 0 | ($.setTempRet0(0), t);
        var n = Array.prototype.slice.call(arguments);
        x.___cxa_is_pointer_type(r), l.buffer || (l.buffer = _n(4)), _t[l.buffer >> 2] = t, 
        t = l.buffer;
        for (var o = 0; o < n.length; o++) if (n[o] && x.___cxa_can_catch(n[o], r, t)) return t = _t[t >> 2], 
        e.adjusted = t, 0 | ($.setTempRet0(n[o]), t);
        return t = _t[t >> 2], 0 | ($.setTempRet0(r), t);
    }
    function y(t, r) {
        Nt.varargs = r;
        try {
            var n = Nt.get(), o = Nt.get(), i = Nt.get();
            for (t = 0, y.buffer || (y.buffers = [ null, [], [] ], y.printChar = function(t, r) {
                                ...
                                if (192 == (224 & i)) o += String.fromCharCode((31 & i) << 6 | _); else {
                                    ...
                                    if (224 == (240 & i)) i = (15 & i) << 12 | _ << 6 | a; else {
                                        ...
                                        if (240 == (248 & i)) i = (7 & i) << 18 | _ << 12 | a << 6 | p; else {
                                            var u = 63 & n[r++];
                                            i = 248 == (252 & i) ? (3 & i) << 24 | _ << 18 | a << 12 | p << 6 | u : (1 & i) << 30 | _ << 24 | a << 18 | p << 12 | u << 6 | 63 & n[r++];
                                        }
                                    }
                ...
                for (var _ = _t[o + 8 * r >> 2], a = _t[o + (8 * r + 4) >> 2], p = 0; p < a; p++) y.printChar(n, nt[_ + p]);
                t += a;
            }
            return t;
        } catch (t) {
    ...
    function d(t) {
        function e() {
            if (!x.calledRun && (x.calledRun = !0, !tt)) {
                if (Mt || (Mt = !0, p(gt)), p(St), x.onRuntimeInitialized && x.onRuntimeInitialized(), 
                x.postRun) for ("function" == typeof x.postRun && (x.postRun = [ x.postRun ]); x.postRun.length; ) Rt.unshift(x.postRun.shift());
                p(Rt);
            }
        }
        if (null === sn && (sn = Date.now()), !(0 < wt)) {
            if (x.preRun) for ("function" == typeof x.preRun && (x.preRun = [ x.preRun ]); x.preRun.length; ) Et.unshift(x.preRun.shift());
            p(Et), 0 < wt || x.calledRun || (x.setStatus ? (x.setStatus("Running..."), setTimeout((function() {
                setTimeout((function() {
                    x.setStatus("");
                }), 1), e();
            }), 1)) : e());
    ...
    function b(t) {
        x.onAbort && x.onAbort(t), void 0 !== t ? (x.print(t), x.printErr(t), t = JSON.stringify(t)) : t = "", 
        tt = !0;
        var e = "abort(" + t + ") at " + o() + "\nIf this abort() is unexpected, build with -s ASSERTIONS=1 which can give more information.";
        throw ln && ln.forEach((function(r) {
            e = r(e, t);
        })), e;
    }
    function h() {}
    ...
    function S() {
        this.ptr = Xe(), A(S)[this.ptr] = this;
    }
    function D() {
        this.ptr = Qe(), A(D)[this.ptr] = this;
    }
    function R() {
        this.ptr = zt(), A(R)[this.ptr] = this;
    }
    function M() {
        this.ptr = Tr(), A(M)[this.ptr] = this;
    }
    function w() {
        this.ptr = Xt(), A(w)[this.ptr] = this;
    }
    function G() {
        this.ptr = Vt(), A(G)[this.ptr] = this;
    }
    function O() {
        this.ptr = Ue(), A(O)[this.ptr] = this;
    }
    function P() {
        this.ptr = fr(), A(P)[this.ptr] = this;
    }
    function j() {
        this.ptr = we(), A(j)[this.ptr] = this;
    }
    function C() {
        this.ptr = Se(), A(C)[this.ptr] = this;
    }
    function N() {
        this.ptr = $e(), A(N)[this.ptr] = this;
    }
    function F() {
    ...
    var Q, W = {};
    for (Q in x) x.hasOwnProperty(Q) && (W[Q] = x[Q]);
    var q, Y, X = !1, K = !1, Z = !1, J = !1;
    if (x.ENVIRONMENT) if ("WEB" === x.ENVIRONMENT) X = !0; else if ("WORKER" === x.ENVIRONMENT) K = !0; else if ("NODE" === x.ENVIRONMENT) Z = !0; else {
        ...
        J = !0;
    } else X = "object" == typeof window, K = "function" == typeof importScripts, Z = "object" == typeof process && "function" == typeof require && !X && !K, 
    J = !X && !Z && !K;
    if (Z) x.print || (x.print = console.log), x.printErr || (x.printErr = console.warn), 
    x.read = function(t, e) {
        return q || (q = require("fs")), Y || (Y = require("path")), t = Y.normalize(t), 
        t = q.readFileSync(t), e ? t : t.toString();
    }, x.readBinary = function(t) {
        return (t = x.read(t, !0)).buffer || (t = new Uint8Array(t)), e(t.buffer), t;
    }, x.thisProgram || (x.thisProgram = 1 < process.argv.length ? process.argv[1].replace(/\\/g, "/") : "unknown-program"), 
    x.arguments = process.argv.slice(2), process.on("uncaughtException", (function(t) {
        if (!(t instanceof m)) throw t;
    })), x.inspect = function() {
        return "[Emscripten Module object]";
    }; else if (J) x.print || (x.print = print), "undefined" != typeof printErr && (x.printErr = printErr), 
    x.read = "undefined" != typeof read ? function(t) {
        return read(t);
    } : function() {
        throw "no read() available";
    }, x.readBinary = function(t) {
        return "function" == typeof readbuffer ? new Uint8Array(readbuffer(t)) : (e("object" == typeof (t = read(t, "binary"))), 
        t);
    }, "undefined" != typeof scriptArgs ? x.arguments = scriptArgs : void 0 !== arguments && (x.arguments = arguments), 
    "function" == typeof quit && (x.quit = function(t, e) {
        quit(t);
    }); else {
        if (!X && !K) throw Error("Unknown runtime environment. Where are we?");
        x.read = function(t) {
            var e = new XMLHttpRequest;
            return e.open("GET", t, !1), e.send(null), e.responseText;
        }, K && (x.readBinary = function(t) {
            var e = new XMLHttpRequest;
    ...
    for (Q in x.print || (x.print = function() {}), x.printErr || (x.printErr = x.print), 
    x.arguments || (x.arguments = []), x.thisProgram || (x.thisProgram = "./this.program"), 
    x.quit || (x.quit = function(t, e) {
        throw e;
    }), x.print = x.print, x.printErr = x.printErr, x.preRun = [], x.postRun = [], W) W.hasOwnProperty(Q) && (x[Q] = W[Q]);
    W = void 0;
    var $ = {
        ...
        getNativeTypeSize: function(t) {
            switch (t) {
              ...
              default:
                return "*" === t[t.length - 1] ? $.QUANTUM_SIZE : "i" === t[0] ? (e(0 == (t = parseInt(t.substr(1))) % 8), 
                t / 8) : 0;
            }
        },
        getNativeFieldSize: function(t) {
            return Math.max($.getNativeTypeSize(t), $.QUANTUM_SIZE);
        },
        STACK_ALIGN: 16,
        prepVararg: function(t, r) {
            return "double" === r || "i64" === r ? 7 & t && (e(4 == (7 & t)), t += 4) : e(0 == (3 & t)), 
            t;
        },
        getAlignSize: function(t, e, r) {
            return r || "i64" != t && "double" != t ? t ? Math.min(e || (t ? $.getNativeFieldSize(t) : 0), $.QUANTUM_SIZE) : Math.min(e, 8) : 8;
        },
        ...
        addFunction: function(t) {
            for (var e = 0; e < $.functionPointers.length; e++) if (!$.functionPointers[e]) return $.functionPointers[e] = t, 
            2 * (1 + e);
            throw "Finished up all reserved function pointers. Use a higher value for RESERVED_FUNCTION_POINTERS.";
        },
        removeFunction: function(t) {
            $.functionPointers[(t - 2) / 2] = null;
        },
        warnOnce: function(t) {
            $.warnOnce.shown || ($.warnOnce.shown = {}), $.warnOnce.shown[t] || ($.warnOnce.shown[t] = 1, 
            x.printErr(t));
        },
        funcWrappers: {},
        getFuncWrapper: function(t, r) {
            if (t) {
                e(r), $.funcWrappers[r] || ($.funcWrappers[r] = {});
                var n = $.funcWrappers[r];
                return n[t] || (n[t] = 1 === r.length ? function() {
                    return $.dynCall(r, t);
                } : 2 === r.length ? function(e) {
                    return $.dynCall(r, t, [ e ]);
                } : function() {
                    return $.dynCall(r, t, Array.prototype.slice.call(arguments));
                }), n[t];
            }
        },
        ...
        stackAlloc: function(t) {
            var e = st;
            return st = 15 + (st = st + t | 0) & -16, e;
        },
        staticAlloc: function(t) {
            var e = ct;
            return ct = 15 + (ct = ct + t | 0) & -16, e;
        },
        dynamicAlloc: function(t) {
            var e = _t[ft >> 2];
            return t = -16 & (e + t + 15 | 0), _t[ft >> 2] = t, t >= It && !a() ? (_t[ft >> 2] = e, 
            0) : e;
        },
        ...
        QUANTUM_SIZE: 4,
        __dummy__: 0
    }, tt = 0, et = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0;
    "undefined" != typeof TextDecoder && new TextDecoder("utf-16le");
    var rt, nt, ot, it, _t, at, pt, ut, ct, st, lt, yt, ft, mt = 65536, dt = 16777216, bt = 16777216, ht = ct = st = lt = yt = ft = 0;
    x.reallocBuffer || (x.reallocBuffer = function(t) {
        try {
            if (ArrayBuffer.transfer) var e = ArrayBuffer.transfer(vt, t); else {
                var r = rt;
    ...
    try {
        var At = Function.prototype.call.bind(Object.getOwnPropertyDescriptor(ArrayBuffer.prototype, "byteLength").get);
    ...
    var Tt = x.TOTAL_STACK || 5242880, It = x.TOTAL_MEMORY || 16777216;
    if (It < Tt && x.printErr("TOTAL_MEMORY should be larger than TOTAL_STACK, was " + It + "! (TOTAL_STACK=" + Tt + ")"), 
    x.buffer) var vt = x.buffer; else "object" == typeof WebAssembly && "function" == typeof WebAssembly.Memory ? (x.wasmMemory = new WebAssembly.Memory({
        initial: It / mt
    }), vt = x.wasmMemory.buffer) : vt = new ArrayBuffer(It);
    if (_(), _t[0] = 1668509029, ot[1] = 25459, 115 !== nt[2] || 99 !== nt[3]) throw "Runtime error: expected the system to be little-endian!";
    x.HEAP = void 0, x.buffer = vt, x.HEAP8 = rt, x.HEAP16 = ot, x.HEAP32 = _t, x.HEAPU8 = nt, 
    x.HEAPU16 = it, x.HEAPU32 = at, x.HEAPF32 = pt, x.HEAPF64 = ut;
    var Et = [], gt = [], St = [], Dt = [], Rt = [], Mt = !1;
    e(Math.imul && Math.fround && Math.clz32 && Math.trunc, "this is a legacy browser, build with LEGACY_VM_SUPPORT");
    var wt = 0, Gt = null, Ot = null;
    ...
    !function() {
        ...
        function e() {
            return x.wasmBinary || !X && !K || "function" != typeof fetch ? new Promise((function(e, r) {
                e(t());
            })) : fetch(n, {
        ...
        function r(t, r, o) {
            function i(t, e) {
                if ((p = t.exports).memory) {
                    t = p.memory, e = x.buffer, t.byteLength < e.byteLength && x.printErr("the new buffer in mergeMemory is smaller than the previous one. in native wasm, we should grow memory here"), 
                    e = new Int8Array(e);
                    var r = new Int8Array(t);
                    Pt || e.set(r.subarray(x.STATIC_BASE, x.STATIC_BASE + x.STATIC_BUMP), x.STATIC_BASE), 
                    r.set(e), x.buffer = vt = t, _();
                }
            ...
            if ("object" != typeof WebAssembly) return x.printErr("no native wasm support detected"), 
            !1;
            if (!(x.wasmMemory instanceof WebAssembly.Memory)) return x.printErr("no native wasm Memory in use"), 
            !1;
            if (r.memory = x.wasmMemory, a.global = {
                NaN: NaN,
                Infinity: 1 / 0
            }, a["global.Math"] = t.Math, a.env = r, u(), x.instantiateWasm) try {
            ...
            return x.wasmBinary || "function" != typeof WebAssembly.instantiateStreaming || 0 === n.indexOf("data:") || "function" != typeof fetch ? l(s) : WebAssembly.instantiateStreaming(fetch(n, {
                ...
                x.printErr("wasm streaming compile failed: " + t), x.printErr("falling back to ArrayBuffer instantiation"), 
                l(s);
            })), {};
        }
        var n = "draco_decoder.wasm", o = "draco_decoder.temp.asm.js";
        "function" == typeof x.locateFile && (x.locateFile("draco_decoder.wast"), n = x.locateFile(n), 
        o = x.locateFile(o));
        var a = {
            global: null,
            env: null,
        ...
        x.asm = function(t, e, n) {
            ...
            return e.memoryBase || (e.memoryBase = x.STATIC_BASE), e.tableBase || (e.tableBase = 0), 
            (t = r(t, e)) || b("no binaryen method succeeded. consider enabling more options, like interpreting, if you want that: https://github.com/kripken/emscripten/wiki/WebAssembly#binaryen-methods"), 
            t;
        };
    }(), ht = $.GLOBAL_BASE, ct = ht + 19104, gt.push(), Pt = null, x.STATIC_BASE = ht, 
    x.STATIC_BUMP = 19104;
    var jt = ct;
    ct += 16;
    var Ct = {
        ...
        decRef: function(t) {
            if (t) {
                var r = Ct.infos[t];
                e(0 < r.refcount), r.refcount--, 0 !== r.refcount || r.rethrown || (r.destructor && x.dynCall_vi(r.destructor, t), 
                delete Ct.infos[t], ___cxa_free_exception(t));
            }
        },
        clearRef: function(t) {
    ...
    })), ft = $.staticAlloc(4), lt = (st = $.alignMemory(ct)) + Tt, yt = $.alignMemory(lt), 
    _t[ft >> 2] = yt, x.wasmTableSize = 492, x.wasmMaxTableSize = 492, x.asmGlobalArg = {
        Math,
        Int8Array,
        Int16Array,
        Int32Array,
        ...
        abortOnCannotGrowMemory: function() {
            b("Cannot enlarge memory arrays. Either (1) compile with  -s TOTAL_MEMORY=X  with X higher than the current value " + It + ", (2) compile with  -s ALLOW_MEMORY_GROWTH=1  which allows increasing the size at runtime, or (3) if you want malloc to return NULL (0) instead of this abort, compile with  -s ABORTING_MALLOC=0 ");
        },
        ...
        ___cxa_begin_catch: function(t) {
            var e = Ct.infos[t];
            return e && !e.caught && (e.caught = !0, s.uncaught_exception--), e && (e.rethrown = !1), 
            Ct.caught.push(t), Ct.addRef(Ct.deAdjust(t)), t;
        },
        ...
        ___cxa_throw: function(t, e, r) {
            throw Ct.infos[t] = {
                ...
                caught: !1,
                rethrown: !1
            }, Ct.last = t, "uncaught_exception" in s ? s.uncaught_exception++ : s.uncaught_exception = 1, 
        ...
        ___resumeException: function(t) {
            throw Ct.last || (Ct.last = t), t + " - Exception catching is disabled, this exception cannot be caught. Compile with -s DISABLE_EXCEPTION_CATCHING=0 or DISABLE_EXCEPTION_CATCHING=2 to catch.";
        },
        ...
        ___syscall140: function(t, e) {
            ...
            try {
                ...
                Nt.get();
                var n = Nt.get(), o = Nt.get(), i = Nt.get();
                return FS.llseek(r, n, i), _t[o >> 2] = r.position, r.getdents && 0 === n && 0 === i && (r.getdents = null), 
                0;
            } catch (t) {
                return "undefined" != typeof FS && t instanceof FS.ErrnoError || b(t), -t.errno;
            }
    ...
    x.asm = Bt, x.___cxa_can_catch = function() {
    ...
    }, $t = x._emscripten_bind_DecoderBuffer_Init_2 = function() {
    ...
    }, ie = x._emscripten_bind_Decoder_GetAttributeFloatForAllPoints_3 = function() {
    ...
    }, ae = x._emscripten_bind_Decoder_GetAttributeIdByMetadataEntry_3 = function() {
    ...
    }, ce = x._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3 = function() {
        return x.asm._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3.apply(null, arguments);
    }, se = x._emscripten_bind_Decoder_GetAttributeInt32ForAllPoints_3 = function() {
        return x.asm._emscripten_bind_Decoder_GetAttributeInt32ForAllPoints_3.apply(null, arguments);
    }, le = x._emscripten_bind_Decoder_GetAttributeInt8ForAllPoints_3 = function() {
        return x.asm._emscripten_bind_Decoder_GetAttributeInt8ForAllPoints_3.apply(null, arguments);
    }, ye = x._emscripten_bind_Decoder_GetAttributeIntForAllPoints_3 = function() {
    ...
    }, me = x._emscripten_bind_Decoder_GetAttributeUInt16ForAllPoints_3 = function() {
        return x.asm._emscripten_bind_Decoder_GetAttributeUInt16ForAllPoints_3.apply(null, arguments);
    }, de = x._emscripten_bind_Decoder_GetAttributeUInt32ForAllPoints_3 = function() {
        return x.asm._emscripten_bind_Decoder_GetAttributeUInt32ForAllPoints_3.apply(null, arguments);
    }, be = x._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3 = function() {
    ...
    }, De = x._emscripten_bind_DracoFloat32Array_GetValue_1 = function() {
    ...
    }, je = x._emscripten_bind_DracoInt32Array_DracoInt32Array_0 = function() {
    ...
    }, $e = x._emscripten_bind_GeometryAttribute_GeometryAttribute_0 = function() {
    ...
    }, Ar = x._emscripten_bind_PointAttribute_GetAttributeTransformData_0 = function() {
    ...
    }, Dr = x._emscripten_bind_PointAttribute_normalized_0 = function() {
    ...
    }, jr = x._emscripten_bind_PointCloud_num_points_0 = function() {
    ...
    }, $r = x._emscripten_enum_draco_StatusCode_INVALID_PARAMETER = function() {
    ...
    }, nn = x._emscripten_enum_draco_StatusCode_UNSUPPORTED_VERSION = function() {
    ...
    }, $.stackAlloc = x.stackAlloc, $.stackSave = x.stackSave, $.stackRestore = x.stackRestore, 
    $.establishStackSpace = x.establishStackSpace, $.setTempRet0 = x.setTempRet0, $.getTempRet0 = x.getTempRet0, 
    x.asm = Bt, Pt) if ("function" == typeof x.locateFile ? Pt = x.locateFile(Pt) : x.memoryInitializerPrefixURL && (Pt = x.memoryInitializerPrefixURL + Pt), 
    Z || J) {
        var an = x.readBinary(Pt);
        nt.set(an, $.GLOBAL_BASE);
    } else {
        var pn = function() {
            x.readAsync(Pt, un, (function() {
                throw "could not load memory initializer " + Pt;
            }));
        };
        u();
        var un = function(t) {
            t.byteLength && (t = new Uint8Array(t)), nt.set(t, $.GLOBAL_BASE), x.memoryInitializerRequest && delete x.memoryInitializerRequest.response, 
            c("memory initializer");
        };
        if (x.memoryInitializerRequest) {
            var cn = function() {
                var t = x.memoryInitializerRequest, e = t.response;
                200 !== t.status && 0 !== t.status ? (console.warn("a problem seems to have happened with Module.memoryInitializerRequest, status: " + t.status + ", retrying " + Pt), 
                pn()) : un(e);
            };
            x.memoryInitializerRequest.response ? setTimeout(cn, 0) : x.memoryInitializerRequest.addEventListener("load", cn);
        } else pn();
    }
    x.then = function(t) {
    ...
    Ot = function t() {
        ...
        e && x.noExitRuntime || (!x.noExitRuntime && (tt = !0, st = void 0, p(Dt), x.onExit) && x.onExit(t), 
        Z && process.exit(t), x.quit(t, new m(t)));
    };
    var ln = [];
    if (x.abort = b, x.preInit) for ("function" == typeof x.preInit && (x.preInit = [ x.preInit ]); 0 < x.preInit.length; ) x.preInit.pop()();
    d(), h.prototype = Object.create(h.prototype), h.prototype.constructor = h, h.prototype.__class__ = h, 
    h.__cache__ = {}, x.WrapperObject = h, x.getCache = A, x.wrapPointer = T, x.castObject = function(t, e) {
        return T(t.ptr, e);
    ...
    var yn = {
        ...
        prepare: function() {
            if (yn.needed) {
                ...
                yn.temps.length = 0, x._free(yn.buffer), yn.buffer = 0, yn.size += yn.needed, yn.needed = 0;
            }
            yn.buffer || (yn.size += 128, yn.buffer = x._malloc(yn.size), e(yn.buffer)), yn.pos = 0;
        },
        alloc: function(t, r) {
            return e(yn.buffer), t = 7 + (t = t.length * r.BYTES_PER_ELEMENT) & -8, yn.pos + t >= yn.size ? (e(0 < t), 
            yn.needed += t, r = x._malloc(t), yn.temps.push(r)) : (r = yn.buffer + yn.pos, yn.pos += t), 
            r;
        },
        copy: function(t, e, r) {
    ...
    return v.prototype = Object.create(h.prototype), v.prototype.constructor = v, v.prototype.__class__ = v, 
    v.__cache__ = {}, x.Status = v, v.prototype.code = v.prototype.code = function() {
        return Nr(this.ptr);
        ...
        Cr(this.ptr);
    }, E.prototype = Object.create(h.prototype), E.prototype.constructor = E, E.prototype.__class__ = E, 
    E.__cache__ = {}, x.DracoUInt16Array = E, E.prototype.GetValue = E.prototype.GetValue = function(t) {
        var e = this.ptr;
        ...
        Ve(this.ptr);
    }, g.prototype = Object.create(h.prototype), g.prototype.constructor = g, g.prototype.__class__ = g, 
    g.__cache__ = {}, x.PointCloud = g, g.prototype.num_attributes = g.prototype.num_attributes = function() {
        return Pr(this.ptr);
    }, g.prototype.num_points = g.prototype.num_points = function() {
        return jr(this.ptr);
    }, g.prototype.__destroy__ = g.prototype.__destroy__ = function() {
        Or(this.ptr);
    }, S.prototype = Object.create(h.prototype), S.prototype.constructor = S, S.prototype.__class__ = S, 
    S.__cache__ = {}, x.DracoUInt8Array = S, S.prototype.GetValue = S.prototype.GetValue = function(t) {
        var e = this.ptr;
        ...
        Ze(this.ptr);
    }, D.prototype = Object.create(h.prototype), D.prototype.constructor = D, D.prototype.__class__ = D, 
    D.__cache__ = {}, x.DracoUInt32Array = D, D.prototype.GetValue = D.prototype.GetValue = function(t) {
        var e = this.ptr;
        ...
        qe(this.ptr);
    }, R.prototype = Object.create(h.prototype), R.prototype.constructor = R, R.prototype.__class__ = R, 
    R.__cache__ = {}, x.AttributeOctahedronTransform = R, R.prototype.InitFromAttribute = R.prototype.InitFromAttribute = function(t) {
        var e = this.ptr;
        ...
        kt(this.ptr);
    }, M.prototype = Object.create(h.prototype), M.prototype.constructor = M, M.prototype.__class__ = M, 
    M.__cache__ = {}, x.PointAttribute = M, M.prototype.size = M.prototype.size = function() {
        return Mr(this.ptr);
    }, M.prototype.GetAttributeTransformData = M.prototype.GetAttributeTransformData = function() {
        return T(Ar(this.ptr), w);
    }, M.prototype.attribute_type = M.prototype.attribute_type = function() {
        return vr(this.ptr);
    }, M.prototype.data_type = M.prototype.data_type = function() {
        return Sr(this.ptr);
    }, M.prototype.num_components = M.prototype.num_components = function() {
        return Rr(this.ptr);
    }, M.prototype.normalized = M.prototype.normalized = function() {
        return !!Dr(this.ptr);
    }, M.prototype.byte_stride = M.prototype.byte_stride = function() {
        return gr(this.ptr);
    }, M.prototype.byte_offset = M.prototype.byte_offset = function() {
        return Er(this.ptr);
    }, M.prototype.unique_id = M.prototype.unique_id = function() {
        return wr(this.ptr);
    }, M.prototype.__destroy__ = M.prototype.__destroy__ = function() {
        Ir(this.ptr);
    }, w.prototype = Object.create(h.prototype), w.prototype.constructor = w, w.prototype.__class__ = w, 
    w.__cache__ = {}, x.AttributeTransformData = w, w.prototype.transform_type = w.prototype.transform_type = function() {
        return Zt(this.ptr);
    }, w.prototype.__destroy__ = w.prototype.__destroy__ = function() {
        Kt(this.ptr);
    }, G.prototype = Object.create(h.prototype), G.prototype.constructor = G, G.prototype.__class__ = G, 
    G.__cache__ = {}, x.AttributeQuantizationTransform = G, G.prototype.InitFromAttribute = G.prototype.InitFromAttribute = function(t) {
        var e = this.ptr;
        ...
        Qt(this.ptr);
    }, O.prototype = Object.create(h.prototype), O.prototype.constructor = O, O.prototype.__class__ = O, 
    O.__cache__ = {}, x.DracoInt8Array = O, O.prototype.GetValue = O.prototype.GetValue = function(t) {
        var e = this.ptr;
        ...
        ze(this.ptr);
    }, P.prototype = Object.create(h.prototype), P.prototype.constructor = P, P.prototype.__class__ = P, 
    P.__cache__ = {}, x.MetadataQuerier = P, P.prototype.HasEntry = P.prototype.HasEntry = function(t, e) {
        var r = this.ptr;
        return yn.prepare(), t && "object" == typeof t && (t = t.ptr), e = e && "object" == typeof e ? e.ptr : I(e), 
        !!sr(r, t, e);
    }, P.prototype.HasIntEntry = P.prototype.HasIntEntry = function(t, e) {
        var r = this.ptr;
        return yn.prepare(), t && "object" == typeof t && (t = t.ptr), e = e && "object" == typeof e ? e.ptr : I(e), 
        !!lr(r, t, e);
    }, P.prototype.GetIntEntry = P.prototype.GetIntEntry = function(t, e) {
        var r = this.ptr;
        return yn.prepare(), t && "object" == typeof t && (t = t.ptr), e = e && "object" == typeof e ? e.ptr : I(e), 
        pr(r, t, e);
    }, P.prototype.HasDoubleEntry = P.prototype.HasDoubleEntry = function(t, e) {
        var r = this.ptr;
        return yn.prepare(), t && "object" == typeof t && (t = t.ptr), e = e && "object" == typeof e ? e.ptr : I(e), 
        !!cr(r, t, e);
    }, P.prototype.GetDoubleEntry = P.prototype.GetDoubleEntry = function(t, e) {
        var r = this.ptr;
        return yn.prepare(), t && "object" == typeof t && (t = t.ptr), e = e && "object" == typeof e ? e.ptr : I(e), 
        _r(r, t, e);
    }, P.prototype.HasStringEntry = P.prototype.HasStringEntry = function(t, e) {
        var r = this.ptr;
        return yn.prepare(), t && "object" == typeof t && (t = t.ptr), e = e && "object" == typeof e ? e.ptr : I(e), 
        !!yr(r, t, e);
    }, P.prototype.GetStringEntry = P.prototype.GetStringEntry = function(t, e) {
        var n = this.ptr;
        return yn.prepare(), t && "object" == typeof t && (t = t.ptr), e = e && "object" == typeof e ? e.ptr : I(e), 
        r(ur(n, t, e));
    }, P.prototype.NumEntries = P.prototype.NumEntries = function(t) {
        var e = this.ptr;
        return t && "object" == typeof t && (t = t.ptr), mr(e, t);
    }, P.prototype.GetEntryName = P.prototype.GetEntryName = function(t, e) {
        var n = this.ptr;
        return t && "object" == typeof t && (t = t.ptr), e && "object" == typeof e && (e = e.ptr), 
        r(ar(n, t, e));
    }, P.prototype.__destroy__ = P.prototype.__destroy__ = function() {
        dr(this.ptr);
    }, j.prototype = Object.create(h.prototype), j.prototype.constructor = j, j.prototype.__class__ = j, 
    j.__cache__ = {}, x.DracoInt16Array = j, j.prototype.GetValue = j.prototype.GetValue = function(t) {
        var e = this.ptr;
        ...
        Oe(this.ptr);
    }, C.prototype = Object.create(h.prototype), C.prototype.constructor = C, C.prototype.__class__ = C, 
    C.__cache__ = {}, x.DracoFloat32Array = C, C.prototype.GetValue = C.prototype.GetValue = function(t) {
        var e = this.ptr;
        ...
        Re(this.ptr);
    }, N.prototype = Object.create(h.prototype), N.prototype.constructor = N, N.prototype.__class__ = N, 
    N.__cache__ = {}, x.GeometryAttribute = N, N.prototype.__destroy__ = N.prototype.__destroy__ = function() {
        tr(this.ptr);
    }, F.prototype = Object.create(h.prototype), F.prototype.constructor = F, F.prototype.__class__ = F, 
    F.__cache__ = {}, x.DecoderBuffer = F, F.prototype.Init = F.prototype.Init = function(t, e) {
        var r = this.ptr;
        if (yn.prepare(), "object" == typeof t && "object" == typeof t) {
            var n = yn.alloc(t, rt);
            yn.copy(t, rt, n), t = n;
        }
        e && "object" == typeof e && (e = e.ptr), $t(r, t, e);
    }, F.prototype.__destroy__ = F.prototype.__destroy__ = function() {
        te(this.ptr);
    }, U.prototype = Object.create(h.prototype), U.prototype.constructor = U, U.prototype.__class__ = U, 
    U.__cache__ = {}, x.Decoder = U, U.prototype.GetEncodedGeometryType = U.prototype.GetEncodedGeometryType = function(t) {
        var e = this.ptr;
        ...
        var n = this.ptr;
        return yn.prepare(), t && "object" == typeof t && (t = t.ptr), e = e && "object" == typeof e ? e.ptr : I(e), 
        r = r && "object" == typeof r ? r.ptr : I(r), ae(n, t, e, r);
        ...
        var n = this.ptr;
        return t && "object" == typeof t && (t = t.ptr), e && "object" == typeof e && (e = e.ptr), 
        r && "object" == typeof r && (r = r.ptr), !!Te(n, t, e, r);
        ...
        var n = this.ptr;
        return t && "object" == typeof t && (t = t.ptr), e && "object" == typeof e && (e = e.ptr), 
        r && "object" == typeof r && (r = r.ptr), !!de(n, t, e, r);
        ...
        ge(this.ptr);
    }, B.prototype = Object.create(h.prototype), B.prototype.constructor = B, B.prototype.__class__ = B, 
    B.__cache__ = {}, x.Mesh = B, B.prototype.num_faces = B.prototype.num_faces = function() {
        return or(this.ptr);
        ...
        rr(this.ptr);
    }, z.prototype = Object.create(h.prototype), z.prototype.constructor = z, z.prototype.__class__ = z, 
    z.__cache__ = {}, x.VoidPtr = z, z.prototype.__destroy__ = z.prototype.__destroy__ = function() {
        Br(this.ptr);
    }, L.prototype = Object.create(h.prototype), L.prototype.constructor = L, L.prototype.__class__ = L, 
    L.__cache__ = {}, x.DracoInt32Array = L, L.prototype.GetValue = L.prototype.GetValue = function(t) {
        var e = this.ptr;
        ...
        Ne(this.ptr);
    }, k.prototype = Object.create(h.prototype), k.prototype.constructor = k, k.prototype.__class__ = k, 
    k.__cache__ = {}, x.Metadata = k, k.prototype.__destroy__ = k.prototype.__destroy__ = function() {
        hr(this.ptr);
    }, function() {
        function t() {
            x.OK = en(), x.ERROR = Jr(), x.IO_ERROR = tn(), x.INVALID_PARAMETER = $r(), x.UNSUPPORTED_VERSION = nn(), 
            x.UNKNOWN_VERSION = rn(), x.INVALID_GEOMETRY_TYPE = Vr(), x.POINT_CLOUD = Hr(), 
            x.TRIANGULAR_MESH = Qr(), x.ATTRIBUTE_INVALID_TRANSFORM = zr(), x.ATTRIBUTE_NO_TRANSFORM = Lr(), 
            x.ATTRIBUTE_QUANTIZATION_TRANSFORM = xr(), x.ATTRIBUTE_OCTAHEDRON_TRANSFORM = kr(), 
            x.INVALID = Yr(), x.POSITION = Kr(), x.NORMAL = Xr(), x.COLOR = Wr(), x.TEX_COORD = Zr(), 
            x.GENERIC = qr();
        }
