...
var e = function(t) {
                ...
                if (192 == (224 & n)) r += String.fromCharCode((31 & n) << 6 | o); else {
                    ...
                    if (224 == (240 & n)) n = (15 & n) << 12 | o << 6 | i; else {
                        ...
                        if (240 == (248 & n)) n = (7 & n) << 18 | o << 12 | i << 6 | _; else {
                            var a = 63 & t[e++];
                            n = 248 == (252 & n) ? (3 & n) << 24 | o << 18 | i << 12 | _ << 6 | a : (1 & n) << 30 | o << 24 | i << 18 | _ << 12 | a << 6 | 63 & t[e++];
                        }
                    }
    ...
    K = !q && !X && !Y;
    for (V in X ? (L.read = function(t, e) {
    ...
    "function" == typeof quit && (L.quit = function(t, e) {
        ...
        document.title = t;
    }), L.print = "undefined" != typeof console ? console.log.bind(console) : "undefined" != typeof print ? print : null, 
    ...
    }(), et = 14480 + (ut = 1024), dt.push(), L.STATIC_BASE = ut, L.STATIC_BUMP = 14480;
    var Dt = et;
    et += 16;
    var gt = {
        last: 0,
    ...
    var Jr = {
        ...
        alloc: function(t, e) {
            return r(Jr.buffer), t = 7 + (t = t.length * e.BYTES_PER_ELEMENT) & -8, Jr.pos + t >= Jr.size ? (r(0 < t), 
