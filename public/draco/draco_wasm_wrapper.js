...
var e = function(t) {
                                ...
                                if (192 == (224 & i)) o += String.fromCharCode((31 & i) << 6 | _); else {
                                    ...
                                    if (224 == (240 & i)) i = (15 & i) << 12 | _ << 6 | a; else {
                                        ...
                                        if (240 == (248 & i)) i = (7 & i) << 18 | _ << 12 | a << 6 | p; else {
                                            var u = 63 & n[r++];
                                            if (248 == (252 & i)) i = (3 & i) << 24 | _ << 18 | a << 12 | p << 6 | u; else i = (1 & i) << 30 | _ << 24 | a << 18 | p << 12 | u << 6 | 63 & n[r++];
                                        }
                                    }
    ...
    var yn = {
        ...
        alloc: function(t, r) {
            return e(yn.buffer), t = (t = t.length * r.BYTES_PER_ELEMENT) + 7 & -8, yn.pos + t >= yn.size ? (e(0 < t), 
